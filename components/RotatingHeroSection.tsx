...
export function RotatingHeroSection({ 
  ...
  return (
    <section className="relative flex min-h-[560px] items-center overflow-hidden text-white sm:min-h-[620px]">
      ...
      {/* Content */}
      <div className="shell relative z-10 -translate-y-4 py-16 sm:-translate-y-12 sm:py-20">
        <p className="eyebrow">Autumn / Winter 2026</p>
        <h1 className="mt-5 max-w-3xl font-display text-[2.65rem] leading-[.98] drop-shadow-md sm:text-7xl">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <Link className="button w-full bg-white text-navy hover:bg-highland hover:text-white sm:w-auto" href="/shop">
            Shop new arrivals
          </Link>
          <Link className="button w-full border border-white bg-transparent hover:bg-white hover:text-navy sm:w-auto" href="/complete-looks">
            Explore looks
          </Link>
        </div>
      </div>
